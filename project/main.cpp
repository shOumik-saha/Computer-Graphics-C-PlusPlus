...
GLfloat Speed10=0.002;
GLfloat Speed11=0.001;
...
void cloudsky()
{
    ...
    glVertex2f(-1.0,-0.3);
    glVertex2f(1.0,-0.3);
    glColor4f(0.3f, 0.34f, 0.32f, 1.0f);
    glVertex2f(1.0,1.0);
    glVertex2f(-1.0,1.0);
    glEnd();
...
if(positionBoard > -0.9 && positionBoard > 0.2 )
positionBoard  = 0.0f;
...
{ //small
if(positionBoard2 <-0.3 && positionBoard2 < 0.3 )
positionBoard2 = 0.18f;
...
void tank()
{
        ...
        glBegin(GL_POLYGON);
            ...
            glVertex2f(0.58,-0.733);
            glVertex2f(0.58,-0.713);
...
void helicopter()
{
     glBegin(GL_POLYGON);
            ...
            glBegin(GL_POLYGON);
            glColor3ub(0,0,0);
            glVertex2f(-0.12,0.835);
            glVertex2f(-0.04,0.835); //helicopter_backfan
            glVertex2f(-0.04,0.825);
            glVertex2f(-0.12,0.825);
            glEnd();
            glBegin(GL_POLYGON);
            glColor3ub(0,0,0);
            glVertex2f(-0.076,0.88);
            glVertex2f(-0.084,0.88);  //helicopter_another backfan
            glVertex2f(-0.084,0.78);
            glVertex2f(-0.076,0.78);
            glEnd();
            glBegin(GL_POLYGON);
            glColor3ub(0,0,0);
            glVertex2f(0.3,0.73);
            ...
            glVertex2f(0.21,0.73);
            glVertex2f(0.23,0.73);
            glVertex2f(0.23,0.77);  //anotherfrontfan
            glVertex2f(0.21,0.77);
            glEnd();*/
